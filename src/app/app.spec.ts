...
describe('App', () => {
  ...
  it('should render title', async () => {
    ...
    expect(compiled.querySelector('.brand-text p')?.textContent).toContain('build 8');
    ...
    expect(compiled.querySelector('a[routerlink="/terminal"]')?.textContent).toContain('Terminal');
  });
});
